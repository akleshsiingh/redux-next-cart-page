        ...
        <nav className="bg-white shadow-md p-4">
            <div className="container mx-auto flex justify-between items-center">
                <div className="flex items-center">
                    ...
                    <span className="text-green-900 ml-3 text-2xl font-bold">Redux cart | NextJS | ReactJS</span>
                </div>
                ...
                <div className="flex items-center">
                    <button className="relative">
                        ...
                        {totalQuantity > 0 && <span className="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full">
                            {totalQuantity}
                        </span>}
                    </button>
                </div>
